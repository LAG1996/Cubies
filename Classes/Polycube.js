function PolyCube(position, name = ""){
	...
	this.GetParallelCuts = function(edge)
	{
		var list = AdjacencyGraph.GetParallelCuts(edge.name)
		return {'parent': [edge, edge['incidentEdge']], 'children' : list}
	}

	this.GetPerpendicularCuts = function(edge)
	{
		var list = AdjacencyGraph.GetPerpendicularCuts(edge.name)
		return {'parent': [edge, edge['incidentEdge']], 'children' : list}
	}

	this.GetCollinearCuts = function(edge)
	{
		var list = AdjacencyGraph.GetCollinearCuts(edge.name)
		return {'parent': [edge, edge['incidentEdge']], 'children' : list}
	}
	...
	{
		return AdjacencyGraph.GetSubGraphs(edge.name)
	}
