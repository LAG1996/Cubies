function FaceEdgeDualGraph(){
	...
	this.AddNeighboringEdges = function(name_1, edge_1, endPoints_1, name_2, edge_2, endPoints_2)
	{
		...
		if(!(name_1 in Edges))
		{
			new_edge_1 = {"name": name_1, "edge": edge_1, "endPoints" : endPoints_1, "neighbors": {}, 'collinearNeighbors': {}, "cut" : true, "invalid": false, "visited": false}
		...
		if(!(name_2 in Edges))
		{
			new_edge_2 = {"name": name_2, "edge": edge_2, "neighbors": {}, "endPoints" : endPoints_2, 'collinearNeighbors': {}, "cut" : true, "invalid": false, "visited": false}
	...
	function GenerateSubGraphs(rotation_line_index)
	{
		...
		GreedyPathGrow(Faces[rot_line[0]['edge'].parent.name])
		jindex = 1
		GreedyPathGrow(Faces[rot_line[0]['incidentEdge']['edge'].parent.name])
